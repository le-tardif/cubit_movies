...
abstract class $MovieCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String title, String urlImage, String description});
}
...
class _$_Movie implements _Movie {
  ...
  @override
  String toString() {
    return 'Movie(id: $id, title: $title, urlImage: $urlImage, description: $description)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, urlImage, description);
...
abstract class _Movie implements Movie {
  const factory _Movie(
      ...
      required final String description}) = _$_Movie;
